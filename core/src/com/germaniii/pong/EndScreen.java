...
public class EndScreen extends ScreenAdapter {
    ...
    public EndScreen(Main game, GameClass score) {
        this.game = game;
        this.score = score;
    }
    ...
    public void render(float delta) {
        ...
        game.batch.begin();
        game.font.draw(game.batch, "You got " + score.getScore() + " points!", Gdx.graphics.getWidth() * .25f, Gdx.graphics.getHeight() * .75f);
